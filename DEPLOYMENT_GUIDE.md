...
- Root Directory: `AssistLink-Backend`
...
1.  Open `AssistLink-Backend/AssistLink-Frontend/app.config.js`.
...
Run the following command in your terminal (inside `AssistLink-Backend/AssistLink-Frontend`):
